...
def process_dataset(raw_dir: str, processed_dir: str, model_name: str = 'yolo26n.pt', debug: bool = False):
    ...
    if not debug:
        for breed in os.listdir(raw_path):
            ...
            out_breed_dir = processed_path / breed
            ...
            for img_name in os.listdir(breed_dir):
                ...
                if best_box is not None:
                    ...
                    print(f"No cat or dog found in image: {img_path}") 
                    continue # skip in case no dog or cat is found in a dog or cat breed folder
...
if __name__ == '__main__':
    ...
    process_dataset(str(raw_dir), str(processed_dir), debug=False)
