...
def process_dataset(
    ...
    for breed in os.listdir(raw_dir):
        ...
        if breed in CAT_BREEDS:
            ...
            print(
                f"error, please download the correct dataset from filen and unpack it correctly -_- for breed: {breed}"
            )
            exit(1)
...
if __name__ == "__main__":
    ...
    processed_dir = animal_recog_dir / "data" / "processed_yolo"
    rejected_dir = animal_recog_dir / "data" / "rejected_yolo"
